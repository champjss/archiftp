package org.microx.felixcontroller;
    ...
    **/
    ...
    public static void createShutdownHook() {
    	Thread shutdownHook = new Thread() {
    	    public void run() {
    	        try {
    	        	System.out.println("\nShutdownHook is shutting down...");
					m_felix.stop();
					System.out.println("Framework was shutdown.");
				}
				catch (BundleException ex) {
					System.err.println("Could not stop framework in the normal way: " + ex);
					ex.printStackTrace();
				}
    	    }
    	};
